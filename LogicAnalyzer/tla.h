...
typedef enum { tr_address, tr_data, tr_addr_data, tr_reset, tr_irq, tr_firq, tr_nmi, tr_manual, tr_none } trigger_t;
...
int tla_printf(const char *, ...) __attribute__((__format__(__printf__, 1, 2)));
